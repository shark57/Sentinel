...
public class AuthorityRuleController {
    ...
    private DynamicRuleProvider<List<AuthorityRuleEntity>> authRuleNacosProvider;
    ...
    private DynamicRulePublisher<List<AuthorityRuleEntity>> authRuleNacosPublisher;
